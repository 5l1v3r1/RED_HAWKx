...
<img src="http://techdenlab.cf/logo.jpg" width="100" height="100">

    red hawk is tool for information gathering  and to get whios lookup,
    <p align="center">
	<img src="https://i.imgur.com/GNWwMFb.png" width="600px">
</p>

#### Version 2.0.0
#### By geek hayden of techdenlabs
...
# Usage:
- git clone `https://github.com/techdenlab/RED_HAWK`
- cd RED_HAWK
- php rhawk.php
...
Want to contribute to RED HAWK or point out something wrong? Just create a new issue here:
